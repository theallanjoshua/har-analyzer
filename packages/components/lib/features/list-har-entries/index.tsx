...
import { ListHAREntriesTablePreferencesProvider, useListHAREntriesTablePreferences } from './user-preferences';
...
export interface ListHAREntriesProps {
	harEntries: HAREntry[];
...
export default function ListHAREntries({
	...
	return <ListHAREntriesTablePreferencesProvider>
		<EnhancedTable
			useTablePreferences={useListHAREntriesTablePreferences}
		...
		/>
	</ListHAREntriesTablePreferencesProvider>;
}
